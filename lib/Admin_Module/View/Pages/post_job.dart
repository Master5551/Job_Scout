...
Future<TimeOfDay?> _selectTime(BuildContext context, TimeOfDay initialTime) async {
  ...
  onTap: () async {
    final selectedDate = await _selectDate(context, controller.selectedDate);
    if (selectedDate != null) {
      final selectedTime = await _selectTime(context, controller.selectedTime);
      if (selectedTime != null) {
        ...
        final formattedDate = DateFormat('yyyy-MM-dd hh:mm a z', 'en_US')
            .format(dateTime.toUtc()); // Format as GMT
        controller.lastApplicationDateController.text = formattedDate;
      }
    }
  },
  decoration: InputDecoration(
